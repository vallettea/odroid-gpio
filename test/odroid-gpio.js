...
describe("odroid-gpio", function() {
	describe(".open", function() {
		...
		it("should set the direction correctly", function(done) {
			fs.readFile("/sys/devices/virtual/gpio/gpio104/direction", "utf8", function(err, data) {
				should.not.exist(err);
		...
		it("should write the value of the pin", function(done) {
			gpio.setDirection(16, "output", function(err) {
				...
				gpio.write(16, "1", function(err) {
					...
					fs.readFile("/sys/devices/virtual/gpio/gpio104/value", "utf8", function(err, data) {
						should.not.exist(err);
